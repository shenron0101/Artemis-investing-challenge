...
```bash
./.venv/bin/python 02_artemis_econometrics/01_build_panel.py
./.venv/bin/python 02_artemis_econometrics/02_characteristics.py
./.venv/bin/python 02_artemis_econometrics/03_network_features.py
./.venv/bin/python 02_artemis_econometrics/04_latent_controls.py
./.venv/bin/python 02_artemis_econometrics/05_models.py
./.venv/bin/python 02_artemis_econometrics/06_backtest.py
./.venv/bin/python 02_artemis_econometrics/07_report.py
```
