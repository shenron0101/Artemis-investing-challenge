...
engine used in 03_nalfp_add/09c_gx_pricing_full.py. The final shortlist is then
...
ROOT = STAGE.parent
DATA09 = ROOT / "03_nalfp_add" / "artifacts" / "data"
...
def load_gx_engine():
    path = ROOT / "03_nalfp_add" / "09c_gx_pricing_full.py"
